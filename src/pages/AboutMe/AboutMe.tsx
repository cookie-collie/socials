                ...
                <Stack>
                    <CardBody px={8}>
                        <Stack gap={4} color={"blackAlpha.700"}>
                            ...
                            <Text fontSize={"xl"}>
                                Feel free to navigate the site however you want!
                                You can click on the links below to visit my
                                Twitter and Twitch. If you want to know more
                                about my commissions and arts, feel free to use
                                the bar on the top!
                            </Text>
